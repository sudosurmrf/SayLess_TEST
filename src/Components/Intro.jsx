...
const Intro = () => {
    return (
      <>
        ...
        <h3>SayLess is a game where your opponent attempts to guess an entire phrase correctly using only a portion of the characters used in the original phrase.</h3>
